...
public:
	...
	static Solenoid* boxDraggersolenoidRU;
	static Solenoid* boxDraggersolenoidRD;
	static Solenoid* boxDraggersolenoidLU;
	static Solenoid* boxDraggersolenoidLD;
	static Compressor* pneumaticcomp;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	static CANTalon* forkliftSpeedController;
