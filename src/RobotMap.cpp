...
void RobotMap::init() {
    ...
    forkliftPID = new PIDController(1,0,0,forkliftencoder, forkliftspeedControllerVertical,0.02);
    lw->AddActuator("Forklift", "PID", forkliftPID);
    forkliftPID->SetAbsoluteTolerance(0.2);
    forkliftPID->SetContinuous(false);
    forkliftPID->SetOutputRange(-1.0, 1.0);
