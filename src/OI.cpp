...
#include "Commands/BoxDraggerGrabCommand.h"
...
OI::OI() {
	...
	SmartDashboard::PutData("BoxDraggerGrabCommand", new BoxDraggerGrabCommand());


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	SmartDashboard::PutNumber("Grabber Amp Limit", 2);
	SmartDashboard::PutNumber("Lift Amp Limit", 100);
	SmartDashboard::PutNumber("Grabber PDP Port", 5);
}
