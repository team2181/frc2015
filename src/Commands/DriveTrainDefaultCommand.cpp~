...
#include "DriveTrainDefaultCommand.h"

DriveTrainDefaultCommand::DriveTrainDefaultCommand() {
...
void DriveTrainDefaultCommand::End() {
	
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void DriveTrainDefaultCommand::Interrupted() {
