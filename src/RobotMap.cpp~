...
CANTalon* RobotMap::forkliftSpeedControllerHorizontal = NULL;
...
void RobotMap::init() {
	...
	forkliftspeedControllerVertical = new Talon(4);
	lw->AddActuator("Forklift", "speedControllerVertical", (Talon*) forkliftspeedControllerVertical);
	
	forkliftlimitUp = new DigitalInput(0);
	lw->AddSensor("Forklift", "limitUp", forkliftlimitUp);
	
	forkliftlimitDown = new DigitalInput(1);
	lw->AddSensor("Forklift", "limitDown", forkliftlimitDown);
	


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

	forkliftSpeedControllerHorizontal = new CANTalon(2);
}
